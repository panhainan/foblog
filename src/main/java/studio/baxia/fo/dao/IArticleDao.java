...
public interface IArticleDao {
     ...
     * @return id
     */
    Integer insert(@Param("article") Article article);
     ...
     * @param article 文章信息（此处可选包括：title、authorsId、categoryId、tagId）
     * @param pageConfig 分页信息（此处可选包括：pageIndex、pageSize）
     * @return
     */
    Integer selectBy(@Param("article") Article article, @Param("pageConfig") PageConfig pageConfig);
